...
{/* 
      ...
      <div className="app__footer-links_work">
        ...
        {/* <p className="p__opensans">{data.workingHours.footerDweekdays.time}</p>
        <p className="p__opensans">{data.workingHours.footerDweekends.days}:</p>
        <p className="p__opensans">{data.workingHours.footerDweekends.time}</p> */}
      </div>
    </div>
