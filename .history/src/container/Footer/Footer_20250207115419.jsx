...
{/* 
      ...
      <div className="app__footer-links_work">
        ...
        <p className="p__opensans">{data.workingHours.footerData.weekdays.time}</p>
        <p className="p__opensans">{data.workingHours.footerData.weekends.days}:</p>
        <p className="p__opensans">{data.workingHours.footerData.weekends.time}</p>
      </div>
    </div>
